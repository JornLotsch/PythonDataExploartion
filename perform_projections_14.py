...
def determine_n_dims(ndimensions, ndimensionsmethod, model, indexGE90):
    ...
    elif ndimensionsmethod == "FixExplainedVariance":
        n_dim = indexGE90
    ...
    elif ndimensionsmethod == "ABCexplainedVariance":
        ABC_n_explainedVariance= ABC_analysis(data=model.explained_variance_ratio_)
        n_dim = len(ABC_n_explainedVariance["Aind"])
    else:
        n_dim = 2
...
def perform_projections(data, y1=None, y2=None, scale=True, showonlyPC12=False, biplot=True, ndimensions=None, minexplainedvarperc=90,
                        ndimensionsmethod="FixExplainedVariance"):

    implemented_ndimensionsmethods = [
        "KaiserGuttman", "FixExplainedVariance", "ABCeigenvalues", "ABCexplainedVariance"]
    ...
    results_grid = plot_results_grid(ndimensionsmethod=ndimensionsmethod, showPCs=showPCs, finalDf=finalDf, scale=scale, 
                                     minexplainedvarperc=minexplainedvarperc, biplot=biplot,
